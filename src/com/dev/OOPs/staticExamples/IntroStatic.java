...
public class IntroStatic {
    ...
    // bcs the static function does not belong to any objects so you cant access the
    // non-static functions
    // To access the non static funtions WE need INSTANCE

    void newFun() {
        number(); // this is possible bcs the non static function can be accesesed in the non
                  // static function
    }
    ...
    // the above one is possible as its the non static function can called by
    ...
    class OuterClass {
        class InnerClass {
            static String name;//
            // here u cant use static as its the non static class u cant use static class
            // variables
            // Bcs outer class depends on some object then how can the inner class variable
            // be dependent ? this is the reason
...
class School {
    ...
    public School(int age, String name, float marks) {
        ...
        // this.studentCount += 1 // this is not allowed bcs basically this keyword
        // replace the instance of the class
    }

    static void test() {
        // as it is the non static variable so you cant access it
        // this.name; // this is also not possible as the staitc method independent of
        // all the instances
        // System.out.println(this.name);// we cant access it as static method.
        // this keyword basically replaysing the object but when coming to static the
        // this key word doesnot refer anything so we cant use it
        // name = "Raja";
    }
...
// Objects are resolved during Runtime so non static methods & class are the
// objectlevel methods
// Contradictory the Static level methods & classes resolved during Compile time
// so those are Class level methods
